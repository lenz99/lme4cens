...
When we use the BFGS-optimization method for the same model:
...
We get very different coefficients, although the log-likelihood is similar.
...
The coefficients currently do not coincide with the results of our `BFGS`-fit!!
...
We need to sort them as appraently the order is different??!!
