...
We use `r NROW(sleepstudy2)` observations from `r nlevels(sleepstudy2$Subject)` of the original `sleepstudy`-dataset.
...
# attach package optimx in order to use it in lme4
library(optimx)
